...
/**
 * #[CastWith] target with a constructor argument, used to exercise the
 * constructor-spread `options` behaviour of CastWithExecutor.
 */
final class CastingFixturePrefixCaster implements CasterInterface
{
