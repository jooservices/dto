...
final class BetweenValidatorTest extends TestCase
{
    ...
    public function test_supports_returns_true_when_between_attribute_present(): void
    {
        $property = $this->createPropertyMeta('percentage', [new Between(0, 100)]);

        $this->assertTrue($this->validator->supports($property, 50));
    }

    public function test_supports_returns_false_when_no_between_attribute(): void
    {
        $property = $this->createPropertyMeta('percentage', []);

        $this->assertFalse($this->validator->supports($property, 50));
    }
    ...
    public function test_validate_passes_for_value_within_range(): void
    {
        $property = $this->createPropertyMeta('percentage', [new Between(0, 100)]);
        $context = $this->createValidationContext($property);

        $this->validator->validate($property, 50, $context);
    ...
    public function test_validate_passes_for_float_within_range(): void
    {
        $property = $this->createPropertyMeta('price', [new Between(0.01, 999.99)]);
        $context = $this->createValidationContext($property);
    ...
    public function test_validate_passes_for_string_numeric_within_range(): void
    {
        $property = $this->createPropertyMeta('percentage', [new Between(0, 100)]);
        $context = $this->createValidationContext($property);
    ...
    public function test_validate_fails_for_value_below_min(): void
    {
        ...
        $this->validator->validate($property, -1, $context);
    }
    ...
    public function test_validate_fails_for_value_above_max(): void
    {
        ...
        $this->expectException(ValidationException::class);
        $this->validator->validate($property, 101, $context);
    }
    ...
    {
        $property = $this->createPropertyMeta('discountRate', [new Between(0, 100)]);
        $context = $this->createValidationContext($property);
        ...
        try {
            ...
            $this->assertSame('discountRate', $violations[0]->getPropertyName());
        }
    }
    ...
    public function test_violation_contains_correct_rule_name(): void
    {
        ...
        try {
            ...
            $violations = $e->getViolations();
            $this->assertSame('between', $violations[0]->getRuleName());
        }
    }

    public function test_custom_message_is_used(): void
    {
        $customMessage = 'Percentage must be between 0 and 100';
        $property = $this->createPropertyMeta('percentage', [new Between(0, 100, message: $customMessage)]);
        $context = $this->createValidationContext($property);
    ...
    public function test_default_message_contains_range_values(): void
    {
        $property = $this->createPropertyMeta('percentage', [new Between(0, 100)]);
        $context = $this->createValidationContext($property);
        ...
        try {
            ...
            $violations = $e->getViolations();
            $this->assertStringContainsString('0', $violations[0]->getMessage());
            $this->assertStringContainsString('100', $violations[0]->getMessage());
        }
    }
